...
If the *Darwin Core* standard is used to record *_Calculator_* output, the *_Calculator_* version and the date of use should be recorded in the field term:dwc[georeferenceSources]. The following format should be used:
